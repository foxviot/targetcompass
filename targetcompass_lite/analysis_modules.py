...
ANALYSIS_MODULES = [
    ...
    },
    {
        ...
        "outputs": [
            "results/genetic_coloc_mr/standard_gwas_summary.tsv",
            "results/genetic_coloc_mr/standard_qtl_summary.tsv",
            "results/genetic_coloc_mr/harmonized_gwas_qtl.tsv",
            "results/genetic_coloc_mr/coloc_results.tsv",
            "results/genetic_coloc_mr/mr_results.tsv",
            "results/genetic_coloc_mr/sensitivity_summary.tsv",
            "results/genetic_coloc_mr/ld_reference_manifest.json",
            "results/genetic_coloc_mr/qc_summary.json",
            "results/genetic_coloc_mr/genetic_evidence.tsv",
