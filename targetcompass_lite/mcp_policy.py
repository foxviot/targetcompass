...
TOOL_SCOPES = {
    ...
    "evidence.db.migrate": "tool:write",
    "evidence.db.snapshot": "tool:write",
    "evidence.db.query": "tool:read",
    "evidence.storage.manifest": "tool:write",
    "evidence.storage.readiness": "tool:write",
    "evidence.trace.query": "tool:read",
    "knowledge.adapt_resources": "knowledge:write",
    "codex.task_packet.inspect": "tool:read",
    "codex.engineering.closure": "tool:write",
    "codex.engineering.release_gate": "tool:write",
    "codex.engineering.sbom": "tool:write",
    ...
    "orchestration.graph.build": "tool:write",
    "orchestration.run": "tool:write",
    "orchestrator.submit": "tool:write",
    "orchestrator.status": "tool:read",
    "orchestrator.cancel": "tool:write",
    "orchestrator.resume": "tool:write",
    "orchestrator.partial_rerun": "tool:write",
    "llm.task.prepare": "tool:write",
    "llm.task.execute": "tool:write",
    "llm.audit.query": "tool:read",
    "mcp.auth.readiness": "tool:write",
    "observability.manifest": "tool:write",
    "service.topology.build": "tool:write",
}
